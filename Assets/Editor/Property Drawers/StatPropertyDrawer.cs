...
//            _baseValue, _maxValue, _currentValue, _minLimit, _maxLimit, _criticalThresholdValue, _statModifiers;
...
//            _statModifiers = property.FindPropertyRelative("_statModifiers");
//            #endregion
...
//                DrawStatsModifiersProperty(_statModifiers, position);
//            }
...
//        private void DrawStatsModifiersProperty(SerializedProperty property, Rect position)
//        {
//            GUIContent content = new GUIContent(
//                "Stats Modifiers",
//                "");
...
//            float xPos = position.min.x + widthOffset /*+ position.width*/;
//            float yPos = position.min.y + YOffset(5, 18);
//            float width = position.size.x + widthOffset /*- position.width*/;
//            float height = EditorGUIUtility.singleLineHeight;
